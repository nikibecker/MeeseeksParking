...
//
//        val lot5 = googleMap.addPolygon(PolygonOptions()
//                .clickable(true)
//                .add(
...
//
//        val lot7 = googleMap.addPolygon(PolygonOptions()
//                .clickable(true)
//                .add(
...
////        polygon1.setTag("alpha")
//
//        val ps1 = googleMap.addPolygon(PolygonOptions()
//                .clickable(true)
//                .add(
...
////        polygon1.setTag("alpha")
//
//        val ps2 = googleMap.addPolygon(PolygonOptions()
//                .clickable(true)
//                .add(
...
////        polygon1.setTag("alpha")
//
//        val ps3 = googleMap.addPolygon(PolygonOptions()
//                .clickable(true)
//                .add(
